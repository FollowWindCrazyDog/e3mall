...
_extend(KDialog, KWidget, {
	init : function(options) {
		...
		var contentDiv = K('<div class="ke-dialog-search"></div>').appendTo(self.div);
		if (_IE && _V < 7) {
	...
	showLoading : function(msg) {
		...
		self.loading = K('<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-search" style="margin-top:' + Math.round(body.height() / 3) + 'px;">' + msg + '</div></div>')
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframeHtml = ['<!doctype html><html><head>',
			'<meta name="viewport" search="initial-scale=1.0, user-scalable=no" />',
			'<style>',
			'	html { height: 100% }',
